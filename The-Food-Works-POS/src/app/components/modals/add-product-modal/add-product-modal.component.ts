...
export class AddProductModalComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private branchService: BranchService, public dialogRef: MatDialogRef<AddProductModalComponent>) { }
  ...
  getProductNames() {
    ...
    this.branchService.getProductNames(this.branchId).subscribe(resp => {
      this.products = resp;
